...
angular.module('optc') .run(function($rootScope, $timeout, $storage, MATCHER_IDS) {
    ...
    var tableFilter = function(settings, data, index) {
        ...
        if (filters.globalKC && [ 3213, 3311, 3275, 3274, 3273, 3269, 3262, 3261, 3259, 3257, 3255, 3253, 5302, 5303, 3251, 3249, 3248, 3247, 3246, 3245, 3241, 3242, 3212 ].indexOf(id) == -1) return false;
