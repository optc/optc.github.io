...
angular.module('optc') .run(function($rootScope, $timeout, $storage, MATCHER_IDS) {
    ...
    var tableFilter = function(settings, data, index) {
        ...
        if (filters.globalKC && [ 3549, 3548, 3547, 3546, 3545, 3544, 3543, 5393, 5394, 5395, 5396, 3540, 3539, 3538, 3537, 3536, 3534, 3550, 1910, 3529, 3528, 3488, 3487, 2372, 2577, 5148, 5149, 5150, 5151, 3179, 2908, 1694, 1571, 3181, 2373, 1733, 1652, 3417, 3212, 2955, 2810, 2781, 2575, 2532, 5062, 5063, 5064, 5065, 2338, 2078, 1957, 1656, 1654, 2082, 2349, 1575, 1828, 1573 ].indexOf(id) == -1) return false;
