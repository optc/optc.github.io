...
angular.module('optc') .run(function($rootScope, $timeout, $storage, MATCHER_IDS) {
    ...
    var tableFilter = function(settings, data, index) {
        ...
        if (filters.globalTM && [ 2910, 2912, 2911, 2895, 5251, 5252, 5253, 5254, 2897, 2860, 5217, 5218, 5219, 2862, 5224, 5225, 5226, 5227, 2909, 2899, 2901, 2903, 2892, 2887, 2888, 2889, 2883, 2885, 2886, 2893, 2908, 2879, 2913, 2880, 2890, 2891, 1707, 1847, 2338, 2434, 2876, 2877, 2878, 603, 836, 1108, 1163, 1432, 1595, 1815, 1879, 1924, 2263, 2356, 2394, 2684, 862, 1141, 1220, 1602, 1667, 1978, 2037, 2354, 2489, 2721, 2755, 1049, 1384, 1867, 1963, 2019, 2127, 2146, 2177, 2219, 2327, 2524, 2753, 2782, 1808, 1916, 1941, 1972, 2000, 5012, 5013, 5014, 5015, 2109, 2175, 2299, 2387, 2443, 2557, 5140, 5141, 5142, 5143, 2583, 2618, 5176, 5177, 5178, 5179, 2659, 2729, 746, 1285, 1372, 1485, 1676, 2283, 1853, 1889, 2064, 2137, 2211, 2261, 2469, 5062, 5063, 5064, 5065, 2510, 2336, 2362, 2690, 2792, 2763, 2823, 2850, 5210, 5211, 5212, 5213, 1387, 1388, 1389, 1446, 1447, 1448, 1549, 1550, 1551 ].indexOf(id) == -1) return false;
        if (filters.globalKC && [ 2921, 2919, 5180, 5181, 5182, 5183, 2913, 2909, 2908, 2903, 2901, 2899, 2897, 2895, 2893, 5251, 5252, 5253, 5254 ].indexOf(id) == -1) return false;
        if (filters.japanTM && [ 3089, 3088, 3087, 3065, 5271, 5272, 5273, 5274, 3071, 3073, 3060, 5263, 5264, 5265, 5266, 3038, 3079, 3067, 3069, 3085, 3082, 3078, 3083, 3080, 3081, 3086, 3040, 3042, 3044, 3047, 3049, 3045, 3046, 1808, 2109, 2261, 2299, 2336, 2362, 2443, 2469, 5062, 5063, 5064, 5065, 2510, 2763, 2823, 2850, 5210, 5211, 5212, 5213, 2879, 3022, 3094, 353, 575, 865, 1298, 1374, 1432, 1595, 1943, 2263, 2394, 2504, 2670, 2684, 2885, 2886, 2893, 2922, 2923, 1733, 1978, 2037, 2111, 2193, 2471, 2721, 2908, 601, 1357, 1416, 1947, 2091, 2751, 2936, 2938, 2940, 2942, 2944, 2946, 2948, 2950, 2952 ].indexOf(id) == -1) return false;
        if (filters.japanKC && [ 3111, 3097, 3094, 3086, 3085, 3083, 3081, 3080, 3079, 3078, 3073, 3071, 3069, 3067, 3065, 5271, 5272, 5273, 5274 ].indexOf(id) == -1) return false;
    ...
    $timeout(function() {
        ...
        var types = { story: 'Story Island', fortnight: 'Fortnight', raid: 'Raid', Coliseum: 'Coliseum', Treasure: 'Treasure Map', Ambush: 'Ambush', Bond: 'Kizuna Clash', PirateFest: 'Pirate Rumble' };
