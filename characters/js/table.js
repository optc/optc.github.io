...
angular.module('optc') .run(function($rootScope, $timeout, $storage, MATCHER_IDS) {
    ...
    var tableFilter = function(settings, data, index) {
        ...
        if (filters.globalKC && [ 3374, 3373, 3372, 3371, 3370, 3369, 3368, 3367, 3366, 3365, 3364, 3361, 3360, 3359, 3358, 3357, 3355, 5339, 5340, 3353, 3352, 3351, 3303, 3071, 3298, 3204, 5296, 5297, 5298, 5299, 3300, 5314, 5315, 5316, 5317, 3349, 5333, 5334, 5335, 5336 ].indexOf(id) == -1) return false;
