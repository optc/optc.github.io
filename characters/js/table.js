...
angular.module('optc') .run(function($rootScope, $timeout, $storage, MATCHER_IDS) {
    ...
    var tableFilter = function(settings, data, index) {
        ...
        if (filters.globalKC && [ 3418, 3420, 2338, 3417, 3403, 3405, 3406, 3407, 3400, 3401, 3398, 3415, 3399, 3416, 3408, 3394, 3397, 3373, 3411, 3509, 3508, 5369, 5370, 5371, 5372, 3391, 3392, 3370, 3371, 3372 ].indexOf(id) == -1) return false;
