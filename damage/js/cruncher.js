...
var CruncherCtrl = function($scope, $rootScope, $timeout) {
    ...
    var getBaseDamageForType = function(type) {
        ...
        team.forEach(function(x,n) {
            ...
            if (orb == 0.5 && x.unit.type == 'DEX' && x.unit.class.has("Shooter")) orb = (window.specials[1640].turnedOn) ? 2 : 0.5;
            if (orb == 'str') orb = (window.specials[1221].turnedOn || window.specials[1222].turnedOn 
                                 ...
                                 || (window.specials[1323].turnedOn && (x.unit.class.has("Driven") || x.unit.class.has("Slasher")))|| (window.specials[1324].turnedOn && (x.unit.class.has("Driven") || x.unit.class.has("Slasher"))) || (window.specials[1593].turnedOn && (x.unit.class.has("Fighter") || x.unit.class.has("Free Spirit")) || (window.specials[1640].turnedOn && x.unit.class.has("Shooter")))) ? 2 : 1;
