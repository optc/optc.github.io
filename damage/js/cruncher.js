...
var CruncherCtrl = function($scope, $rootScope, $timeout) {
    ...
    var getTypeMultiplierOfUnit = function(attackerType,attackedType, unit, teamSlot) {
        ...
        if ($scope.data.effect == 'Kizuna Clash [Global]'){
            if ([ 3111, 3097 ].indexOf(unit.unit.number + 1) != -1) typeMult = $scope.data.superTypeINT ? 2.5 : 2;
        }
            ...
            if (zombie.type == 'healer') {
                if (zombie.hasOwnProperty('amount')) 
                    ...
                    if (!zombie.multiplier){
                        ...
                        healAmount += (id == 1750 || id == 1751 || id == 1922  || id == 2775  || id == 2776 || id == 5083 || id == 5087 || id == 2959 || id == 2960 || id == 3220 || id == 3221 || id == 3117 || id == 3118 || id == 3275) ? (.5 * (data.team[i].rcv + rcvtemp) * rcvmulttemp * hitsCount['Perfect']) : 0;
