            ...
            if (orb =='meat'){
                for (temp = 0; temp < 2; temp++){
                    if (team[temp].unit != null){
                        if ([ 1610, 1609, 1532, 1531, 2232, 2233, 2234, 2500, 2300, 2803, 2804, 5052, 5054, 5055, 5057, 2957, 2957, 3306, 3307, 3814, 3888, 3889, 5453, 5454, 5455, 5456, 5457, 5548, 5459, 5460 ].includes(team[temp].unit.number + 1)){
                            orb = 2;
                        }
