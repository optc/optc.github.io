...
window.CrunchUtils.getOrbMultiplier = function(orb, type, uclass, baseMultiplier, boostedMultiplier, captains, effectName, params) {
    ...
    for(temp = 0; temp < 2; temp++){
        if(captains[temp] != null){
            if([1610, 1609, 1531, 1532, 2232, 2233, 2234, 2500, 2803, 2804, 5052, 5054, 5055, 5057, 2957, 2958, 3306, 3307, 3814, 5453, 5454, 5455, 5456, 5457, 5548, 5459, 5460, 3955, 3956].includes(captains[temp].number + 1)){
                if (orb == 'meat'){
