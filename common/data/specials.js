 ...
 * - `CrunchUtils.getOrbMultiplier(p.orb, p.unit.type, p.unit.class, 1, 1.75, [p.friendCaptain, p.captain], p.effectName, p)`
 *   - Gets the effective orb boost. 1 is the base orb multiplier (neutral orb),
 *     1.75 is the orb boost the special will give.
 *     Check out `window.CrunchUtils.getOrbMultiplier` in "damage\js\utils.js"
 ...
 * - `orb` - returns the *effective* orb boost multiplier. If the unit's orb type
 *   is matching, and the special gives a 2x boost, this function should return 4.
