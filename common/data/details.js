window.details = {
    ...
    1831: {//6* Judge
        captain: "Increase the rate of PSY orbs, reduces damage recieved by 15%, boosts the HP of all characters by 1.25x and if there is a [STR], [DEX], [QCK], [PSY], and [INT] characters in your crew, boosts ARK of al characters by 2.25x.  If any character has a matching orb, boosts THEIR attack by 3.9x (MIGHT BE DIFFERENT DUE TO THIS BEING THE UNEVOLVED FORM)",
    ...
    1832: {//6* Judge
        captain: "Increase the rate of PSY orbs, reduces damage recieved by 15%, boosts the HP of all characters by 1.25x and if there is a [STR], [DEX], [QCK], [PSY], and [INT] characters in your crew, boosts ARK of al characters by 2.25x.  If any character has a matching orb, boosts THEIR attack by 3.9x",
        special: "Reduces bind duration by 7 turns and amplifies the effect of orbs by 2x for 1 turn.  If this character is the captain or the friend captain, slightly boosts the rate of [PSY] orbs and randomly shuffles all orbs including [BLOCK] orbs",
        specialName: "Dengi Crack",
        limit: "This character has a limit break path",
    },
    1833: {//Reiju
        captain: "Boosts ATK of [INT] characters by 1.75x and Powerhouse characters by 1.2x (boosts stack on an [INT] Powerhouse character so boost effectively beomces 2.1x) and the RCV of Powerhouse by 1.1x",
    ...
    1834: {//Reiju
        captain: "Boosts ATK of [INT] characters by 1.75x and Powerhouse characters by 1.2x (boosts stack on an [INT] Powerhouse character so boost effectively beomces 2.1x) and the RCV of Powerhouse by 1.1x (MIGHT BE DIFFERENT DUE TO THIS BEING THE EVOLVED FORM)",
        special: "If your captain is [INT] or [PSY], recovers 7,000 HP, removes poison, and reduces the duration of paralysis, despair, and silence by 3 turns.  If the captain is a powerhouse character, reduces damage recieved by 70% for 2 turns ",
        specialName: "Dangerous Healing",
        sailor: "Makes [PSY] orbs \"beneficial\" for this unit",
        sailorNotes: "#{beneficial}",
    ...
    1835: {//Ichiji
        captain: "Boosts Atk of [STR] by 1.75x, Powerhouse by 1.2x (boosts stacks on a [STR] Powerhouse character so boost effectively becomes 2.1x), and the HP of Powerhouse by 1.2x",
    ...
    1836: {//Ichiji
        captain: "Boosts Atk of [STR] by 1.75x, Powerhouse by 1.2x (boosts stacks on a [STR] Powerhouse character so boost effectively becomes 2.1x), and the HP of Powerhouse by 1.2x (MIGHT BE DIFFERENT DUE TO THIS BEING THE EVOLVED FORM)",
        special: "If your captain is [STR] or[PSY] character, locks chain multiplier at 2.5x for 2 turns. If your Captain is a Powerhouse character, delays all enemies for 2 turns",
        specialName: "Majestic Impact",
        sailor: "Makes [PSY] orbs \"beneficial\" for this unit",
        sailorNotes: "#{beneficial}",
    ...
    1837: {//Niji
        captain: "Boosts Atk of [QCK] by 1.75x, Powerhouse by 1.2x (boosts stacks on a [QCK] Powerhouse character so boost effectively becomes 2.1x), and the HP of Powerhouse by 1.2x",
    ...
    1838: {//Niji
        captain: "Boosts Atk of [QCK] by 1.75x, Powerhouse by 1.2x (boosts stacks on a [QCK] Powerhouse character so boost effectively becomes 2.1x), and the HP of Powerhouse by 1.2x (MIGHT BE DIFFERENT DUE TO THIS BEING THE EVOLVED FORM)",
        special: "If your captain is a [QCK] or [PSY] character, boosts Atk of all characters by 1.75x for 2 turns. If your captain is a Powerhouse character, locks all orbs for 1 turn",
        specialName: "Blitz Needle",
        sailor: "Makes [PSY] orbs \"beneficial\" for this unit",
        sailorNotes: "#{beneficial}",
    ...
    1839: {//Yonji
        captain: "Boosts Atk of [DEX] by 1.75x, Powerhouse by 1.2x (boosts stacks on a [DEX] Powerhouse character so boost effectively becomes 2.1x), and the HP of Powerhouse by 1.2x",
        ...
        specialNotes: "#{random : 10,000 : 30,000} <br> Extra Damage can only be boosted by conditional Boosters <br> MIGHT BE DIFFERENT NUMBERS.  NUMBERS WERE TAKEN FROM SABO",
        sailor: "Makes [PSY] orbs \"beneficial\" for this unit",
        sailorNotes: "#{beneficial}",
    },
    1840: {//Yonji
        captain: "Boosts Atk of [DEX] by 1.75x, Powerhouse by 1.2x (boosts stacks on a [DEX] Powerhouse character so boost effectively becomes 2.1x), and the HP of Powerhouse by 1.2x (MIGHT BE DIFFERENT DUE TO THIS BEING THE EVOLVED FORM)",
        special: "If your captain is [DEX] or [PSY] character, boosts Atk against delayed enemies by 1.75x for 1 turn. If your captain is a Powerhouse character, adds 40x characters Atk as additional typeless damage for 2 turns",
        specialName: "Burst End Kick",
        specialNotes: "#{random : 10,000 : 30,000} <br> Extra Damage can only be boosted by conditional Boosters <br> MIGHT BE DIFFERENT NUMBERS.  NUMBERS WERE TAKEN FROM SABO",
        sailor: "Makes [PSY] orbs \"beneficial\" for this unit",
