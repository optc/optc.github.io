window.details = {
    ...
    1570: {//Inuarashi
        ...
        special: "Reduces crew's current HP by ??%, every attacking character gets 80x character's ATK as additional typeless bonus damage if you hit no lower than Good, and does additional effects",
        specialNotes: "Additional effects are not known yet and may be a new mechanic.",
    ...
    1572: {//Wanda
        ...
        special: "Randomizes non-matching orbs, boosts ATK of Cerebral characters by 1.75x for 3 turns",
    ...
    1574: {//Sicilian
        captain: "Boosts ATK of [INT] characters by ???x and their RCV by ???x",
        special: "Delays all enemies for 1 turn, deals ???x character's ATK [INT] damage to all enemies, and changes all orbs on Cerebral characters into Matching orbs.",
    ...
    1576: {//Kin'emon
        captain: "Boosts ATK by ???x following a chain of Good > Great > Perfect hits, recovers ?x character's RCV in HP at the end of each turn",
        special: "Deals typeless damage to all enemies, and changes all orbs on all characters into Matching orbs.",
        specialNotes: "Not confirmed if it's all characters for the orb shuffle.",
    ...
    1578: {//Momonosuke
        captain: "Boosts ATK, HP and RCV of all characters by ???x, protects from defeat as long as HP is above ???%",
