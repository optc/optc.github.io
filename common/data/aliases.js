window.aliases = {
    ...
    497: ['ポートガス・Ｄ・エース コルボ山の悪ガキ３兄弟',''],
    498: ['ポートガス・Ｄ・エース コルボ山の悪ガキ３兄弟“兄弟盃”',''],
    499: ['ベルメール',''],
    500: ['ベルメール ナミとノジコの養母',''],
    501: ['カヤ',''],
    502: ['カヤ シロップ村のお嬢様',''],
    ...
    547: ['モンキー・D・ルフィ コルボ山の悪ガキ３兄弟',''],
    548: ['モンキー・D・ルフィ コルボ山の悪ガキ３兄弟“兄弟盃”',''],
    549: ['サディちゃん',''],
    ...
    662: ['ナミ バカンス',''],
    663: ['ネフェルタリ・ビビ アラバスタ王国王女',''],
    664: ['ネフェルタリ・ビビ 砂砂団　副リーダー',''],
    665: ['コーザ アラバスタ住民',''],
    666: ['コーザ 砂砂団　リーダー',''],
    ...
    849: ['カティ・フラム トムズ　ワーカーズ','', 'Franky, Tom\'s Workers' ],
    850: ['アイスバーグ トムズ　ワーカーズ','', 'Iceburg, Tom\'s Workers' ],
    851: ['ブリキのワポル',''],
    852: ['スリムアップワポル',''],
    853: ['ロブソン',''],
    854: ['チョッパーの雪遊び',''],
    ...
    903: ['赤鬼のブロギー',''],
    904: ['ヨコヅナ',''],
    905: ['ロロノア・ゾロ クライガナ島をさすらう剣士',''],
    906: ['ロロノア・ゾロ 世界最強剣士の門弟',''],
    907: ['ニコ・ロビン テキーラウルフの収監者',''],
    908: ['ニコ・ロビン 革命の灯火（ともしび）',''],
    909: ['トニートニー・チョッパー トリノ王国の平和の架け橋',''],
    910: ['チョッパーマスク 世界の平和を守るヒーロー',''],
    911: ['サンジ カマバッカ王国の逃走者',''],
    912: ['サンジ 男を懸けた愛の料理人',''],
    913: ['ブルック ハラヘッターニャの悪魔王',''],
    914: ['ブルック 骨（ボーン） to be wild!!!',''],
    915: ['？？？','','Wedding Nico Robin'],
    916: ['？？？','','Bride Nico Robin'],
    917: ['マーガレット',''],
    918: ['マーガレット 護国の戦士',''],
    919: ['アフェランドラ',''],
    920: ['スイトピー',''],
    ...
    932: ['ピーカ',''],
    933: ['ピーカ ドンキホーテ海賊団',''],
    934: ['','', 'Jinbe', 'Jimbe', 'Jinbei'],
    935: ['','', 'Jinbe', 'Jimbe', 'Jinbei'],
    936: ['','','Timeskip Luffy'],
    937: ['','','Timeskip Luffy'],
    938: ['','','Timeskip Nami'],
    939: ['','','Timeskip Nami'],
