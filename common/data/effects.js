...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Treasure Map [Global]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 2848 ].indexOf(id) != -1) boost = 3;
            if([ 2849, 2847, 2835, 5206, 5207, 5208, 5209, 2837, 1387, 1388, 1389, 1446, 1447, 1448, 1549, 1550, 1551 ].indexOf(id) != -1) boost = 2.5;
            if([ 2814, 2839, 2841, 2851, 2832, 2764, 2765, 2846, 2823, 2850, 5210, 5211, 5212, 5213, 2831, 5199, 5200, 5201, 2833, 2767, 2843, 1881, 1985, 5008, 5009, 5010, 5011, 2372, 2373, 2802, 5195, 5196, 5197, 5198, 2804, 2830, 671, 1410, 1959, 1993, 2540, 5108, 5109, 5110, 5111, 2825, 2827, 2829, 2820, 2821, 2822, 418, 603, 1047, 1374, 1830, 1924, 2263, 2281, 2517, 5070, 5071, 5072, 5073, 2552, 5032, 5033, 5034, 5035, 2781, 1043, 1091, 1555, 1603, 1628, 1792, 2037, 2111, 2123, 2163, 2323, 2354, 2375, 2471, 2569, 2721, 2785, 2813, 2845, 1581, 1690, 1810, 1995, 2127, 2219, 2254, 2429, 2491, 2692, 2723, 1808, 1853, 1916, 1941, 1972, 2064, 2109, 2175, 2261, 2336, 2362, 2469, 5062, 5063, 5064, 5065, 2510, 2583, 2729, 2763, 2792, 2815, 1889, 2000, 5012, 5013, 5014, 5015, 2137, 2211, 2299, 2387, 2443, 2557, 5140, 5141, 5142, 5143, 2618, 5176, 5177, 5178, 5179, 2659, 2690 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
    ...
    'Treasure Map [Japan]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 3019, 3020, 3021, 3007, 3009, 2995, 2980, 2982, 3018, 3011, 3013, 3015, 3017, 2999, 3016, 2499, 2767, 3004, 3005 ].indexOf(id) != -1) boost = 2.5;
            //if([ 0 ].indexOf(id) != -1) boost = 1.3;
            if([ 1941, 2109, 2175, 2261, 2443, 2659, 2729, 2792, 2823, 2879, 2977, 3022 ].indexOf(id) != -1) boost = 1.25;
            if([ 2025, 2034, 2338, 2804, 2909, 603, 836, 1518, 2097, 2281, 2473, 2885, 2886, 2893, 2922, 2923, 2956, 779, 862, 1222, 1251, 1553, 1733, 2123, 2193, 2290, 2471, 2649, 2845, 2990, 666, 810, 1918, 2094, 2377, 2521, 2936, 2938, 2940, 2942, 2944, 2946, 2948, 2950, 2952 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
	...
	'Kizuna Clash [Japan]': {
        ...
        hp: function(p) {
            ...
            if([ 2998, 2997, 2996, 2995, 2991, 2990, 2989, 2988, 2987, 2986, 2984, 2982, 2980, 2955 ].indexOf(id) != -1) boost = 2;
            if([ 2889, 2888, 2887, 2853, 2832, 2793, 2756 ].indexOf(id) != -1) boost = 1.5;
            if([ 2977, 2976, 2975, 2974, 2973, 2972, 2970, 2968, 2966, 2964, 2962, 2960, 2958, 2956, 2952, 2950, 2948, 2946, 2944, 2942, 2940, 2938, 2936, 2934, 2893, 2281, 2158, 2097, 2015, 1830, 1595, 1518, 1298, 2521, 2146, 2127, 2095, 2087, 2046, 1995, 1918, 1581, 899 ].indexOf(id) != -1) boost = 1.25;
            return boost;
        },
        rcv: function(p) {
            var boost = 1;
