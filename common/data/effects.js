...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
	...
	'Kizuna Clash [Global]': {
        ...
        atk: function(p) {
            var id = p.number + 1,
                matching = ([ 2921, 2919, 5180, 5181, 5182, 5183, 2913, 2909, 2908, 2903, 2901, 2899, 2897, 2895, 2893, 5251, 5252, 5253, 5254 ].indexOf(id) != -1);
            return !matching ? 1 : 2;
        },
        hp: function(p) {
            var id = p.number + 1,
	...
	'Kizuna Clash [Japan]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 3111, 3097, 3094, 3086, 3085, 3083, 3081, 3080, 3079, 3078, 3073, 3071, 3069, 3067, 3065, 5271, 5272, 5273, 5274 ].indexOf(id) != -1) boost = 2;
