...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Treasure Map [Global]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 2613 ].indexOf(id) != -1) boost = 3;
            if([ 2612, 2614, 2601, 5164, 5165, 5166, 5157, 2603, 5172, 5173, 5174, 5175, 1387, 1388, 1389, 1446, 1447, 1448, 1549, 1550, 1551 ].indexOf(id) != -1) boost = 2.5;
            if([ 2434, 2588, 1912, 1914, 2605, 2607, 2609, 3376, 2611, 2583, 2618, 5176, 5177, 5178, 5179, 2632, 1492, 2365, 2534, 5086, 5087, 5088, 5089, 2561, 5148, 5149, 5150, 5151, 2577, 5156, 5157, 5158, 5159, 1382, 2579, 2580, 2581, 227, 353, 575, 770, 771, 865, 978, 1047, 1879, 2097, 2158, 2197, 2281, 2473, 2517, 5070, 5071, 5072, 5073, 804, 860, 904, 951, 1978, 2123, 2375, 2416, 2550, 5132, 5133, 5134, 5135, 2569, 1995, 2019, 2090, 2091, 2146, 2519, 2520, 2521, 2522, 2523, 2524, 2525, 2526, 2527, 1808, 1853, 1916, 1972, 2261, 2443, 2469, 5062, 5063, 5064, 5065, 2510, 2557, 5140, 5141, 5142, 5143, 1258, 1380, 1530, 1846, 2283, 2381, 2596, 2597, 863, 1360, 1461, 1889, 1941, 2000, 5012, 5013, 5014, 5015, 2064, 2109, 2137, 2175, 2211, 2299, 2336, 2362, 2387 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
    ...
    'Treasure Map [Japan]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 2820, 2822, 2821, 2792, 2802, 5195, 5196, 5197, 5198, 2804 ].indexOf(id) != -1) boost = 2.5;
            //if([ 0 ].indexOf(id) != -1) boost = 1.3;
            if([ 2774, 2776, 2797, 2814, 2806, 2808, 2810, 2795, 5187, 5188, 5189, 5190, 2819, 5048, 5049, 5050, 5051, 2813, 2794, 2812, 2799, 2815, 1808, 1853, 1916, 1941, 2064, 2261, 2469, 5062, 5063, 5064, 5065, 2510, 2729, 2763, 2823 ].indexOf(id) != -1) boost = 1.25;
            if([ 2787, 2789, 2790, 418, 865, 1374, 1518, 1879, 1924, 2015, 2097, 2263, 2356, 2394, 2473, 2698, 2709, 2781, 862, 1310, 1338, 1694, 1733, 2111, 2354, 2569, 2785, 1810, 1855, 2019, 2090, 2167, 2327, 2428, 2457, 2458, 2491, 2526, 2692, 2707 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
	...
	'Kizuna Clash [Japan]': {
        ...
        atk: function(p) {
            var id = p.number + 1,
                matching = ([ 2707, 2709, 2774, 2776, 2778, 2780, 2785, 2787, 2789, 2792, 2802, 5195, 5196, 5197, 5198, 2804, 2806, 2808, 2810 ].indexOf(id) != -1);
            return !matching ? 1 : 2;
        },
        hp: function(p) {
            var id = p.number + 1,
