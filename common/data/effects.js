...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Treasure Map [Global]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 1937, 1939, 1914, 1938, 1936 ].indexOf(id) != -1) boost = 2.5;
            if([ 1912, 1916, 1935, 1747, 1794, 1832, 1869, 1883, 1910, 1928, 1804, 1806, 1849, 1851, 1885, 1889, 1895, 1902, 1904, 1906, 1908, 1926, 1087, 1089, 1102, 1104, 1106, 1143, 1145, 1292, 1341, 1897, 1899, 353, 418, 978, 1108, 1163, 1930, 1943, 1547, 1842, 1844, 1855, 1857, 1865, 1867, 1808, 1853, 1889, 1900 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
    ...
    'Treasure Map [Japan]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 2132, 2134, 2135 ].indexOf(id) != -1) boost = 2.5;
            if([ 2099, 2113, 2074, 2076, 2109, 2115, 2117, 2119, 2121 ].indexOf(id) != -1) boost = 1.25;
            if([ 1413, 1764, 1610, 1910, 2023, 1976, 2017, 2111, 1298, 1518, 1943, 2015, 2033, 2070, 2097, 1037, 1547, 1597, 1766, 1947, 1980, 1982, 2091, 2092, 2093, 2094, 2095, 1916, 2064 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
