...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
	...
	'Girls of Summer Paradise! Blitz Battle': {
        ...
        atk: function(p) {
            ...
            if([ 3361, 514, 662, 681, 683, 685, 686, 1161, 1194, 1199, 1201, 1214, 1674, 1709, 1711, 1729, 1731, 2173, 2191, 2213, 2215, 2217, 2620, 2622, 2624, 2626, 2628, 2630, 2274, 2776, 2835, 2837, 2895, 3009 ].indexOf(id) != -1) boost = 1.5;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
