...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Treasure Map [Worldwide]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 4029, 4032, 4031, 4030, 4011, 4012, 4020, 4025, 4006, 4033 ].indexOf(id) != -1) boost = 2.5;
            if([ 4022, 4023, 4008, 3984, 3986, 3987, 3988, 3993, 3995, 3996, 3997, 3998, 4021, 4010, 5543, 5544, 5545, 5546, 3981, 3990, 3991, 3999, 4000, 3989, 3957, 3621, 3339, 3547, 3491, 3094, 3060, 2729, 2763, 2299, 2261, 5535, 5536, 5537, 5538, 5263, 5264, 5265, 5266, 3364, 3462, 3483, 3523, 3543, 3563, 3641, 3735, 3775, 3861, 3933, 4003, 5393, 5394, 5395, 5396, 5516, 5517, 5518, 5519, 5551, 5552, 5553, 5554, 3862, 3863, 3365, 3366, 3367, 4004, 4005, 3978, 3979, 3980 ].indexOf(id) != -1) boost = 1.25;
            if([ 2936, 2938, 2940, 2942, 2944, 2946, 2948, 2950, 2952, 3884, 3886, 3967, 3971, 3973, 3974, 3975, 4024, 3969, 3976, 2987, 2781, 2473, 2356, 2015, 1879, 1696, 933, 418, 306, 2869, 2953, 2489, 1897, 1733, 1667, 1792, 1043, 3269, 3189, 2707, 2203, 1095, 2205, 1097, 2201, 3693, 2330, 1102, 353, 2332, 1104, 355, 2334, 1106, 1163, 2099, 2105, 1171, 2103, 1167, 2101, 1169, 2107, 1165, 2681, 2883, 2884, 2665, 2666, 3680, 3721, 3816, 3713, 3701, 3698, 3700, 4026, 4027, 4009, 4001, 5531, 5532, 5533, 5534, 5524, 5525, 5526, 5052, 2354, 2158, 2640, 2091, 2089, 1217, 1339, 1051 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
	...
	'Kizuna Clash [Worldwide]': {
        ...
        atk: function(p) {
            ...
            if([ 4034, 4035, 4024, 4012, 4011, 4020, 4022, 4023, 4029, 4030, 4031, 4032, 4025, 4033, 4021, 4037, 2672 ].indexOf(id) != -1) boost = 2;
            if([ 4008, 4009, 3886, 2936, 2938, 2940, 2942, 2944, 2946, 2948, 2950, 2952, 3884, 2749, 2758, 2299, 2763, 3298, 3275, 3917, 3824, 3590, 3508, 3393, 2968, 3993, 3984, 3971, 3973, 3956, 3957, 3908, 3910, 3878, 3877, 3889, 3896, 3474, 3422, 2578, 5488, 5489, 5490, 5491, 5531, 5532, 5533, 5534, 5474, 5475, 5480, 5481, 5482, 5483, 5457, 5458, 5459, 5460, 5453, 5454, 5455, 5456 ].indexOf(id) != -1) boost = 1.5;
        ...
        rainbow: function(p) {
            ...
            if([ 4034, 4035 ].indexOf(id) != -1) return true;
        },
	},
