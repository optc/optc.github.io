...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Treasure Map [Worldwide]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 4094, 4092, 4093, 4088, 4074, 4082, 4084, 4089 ].indexOf(id) != -1) boost = 2.5;
            if([ 4086, 4087, 4058, 4060, 4062, 4064, 4065, 4054, 4068, 4067, 4085, 4066, 4078, 4079, 4080, 4063, 3336, 5559, 5560, 5561, 5562, 5567, 5568, 5569, 5570, 4047, 4053, 4056, 3981, 3822, 3758, 3689, 3467, 3416, 3368, 3094, 2763, 2659, 3364, 3462, 3483, 3523, 3543, 3563, 3641, 3735, 3775, 3861, 3933, 4003, 4050, 4071, 5393, 5394, 5395, 5396, 5516, 5517, 5518, 5519, 5551, 5552, 5553, 5554, 3978, 3979, 3980, 3484, 3485, 4072, 4073, 4051, 4052 ].indexOf(id) != -1) boost = 1.25;
            if([ 2936, 2938, 2940, 2942, 2944, 2946, 2948, 2950, 2952, 3884, 3886, 4048, 4041, 4043, 4044, 4045, 4046, 4037, 4038, 4039, 4021, 2886, 3399, 3078, 2885, 3143, 2642, 2504, 2097, 5012, 1518, 353, 2953, 2569, 2375, 2471, 1945, 3580, 1251, 951, 3773, 3293, 2707, 3307, 2845, 2684, 603, 2782, 2640, 2524, 2457, 1606, 1597 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
	...
	'Kizuna Clash [Worldwide]': {
        ...
        atk: function(p) {
            ...
            if([ 4075, 4076, 4058, 4060, 4062, 4065, 4064, 4074, 4066, 4071, 4072, 4073, 4068, 4067, 4063, 3336, 4080, 3227, 5559, 5560, 5561, 5562, 5567, 5568, 5569, 5570 ].indexOf(id) != -1) boost = 2;
            if([ 3886, 2936, 2938, 2940, 2942, 2944, 2946, 2948, 2950, 2952, 3884, 4054, 4055, 2443, 2469, 2510, 2618, 3393, 3417, 4041, 4043, 3948, 3809, 3745, 3536, 3950, 3926, 3749, 3824, 3391, 3349, 3825, 3760, 3761, 3737, 3624, 3548, 3509, 3392, 3212, 3151, 5062, 5063, 5064, 5065, 5176, 5177, 5178, 5179, 5333, 5334, 5335, 5336 ].indexOf(id) != -1) boost = 1.5;
        ...
        rainbow: function(p) {
            ...
            if([ 4054, 4055 ].indexOf(id) != -1) return true;
        },
	},
