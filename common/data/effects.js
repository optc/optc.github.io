...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
	...
	'Kizuna Clash [Global]': {
        ...
        atk: function(p) {
            var id = p.number + 1,
                matching = ([ 2852, 2853, 2850, 5210, 5211, 5212, 5213, 2846, 2845, 2843, 2841, 2839, 2837, 2835, 5206, 5207, 5208, 5209, 2830 ].indexOf(id) != -1);
            return !matching ? 1 : 2;
        },
        hp: function(p) {
            var id = p.number + 1,
	...
	'Kizuna Clash [Japan]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 3118, 3120, 3121, 3100, 3102, 3104, 3106, 3107, 3108, 3109, 3110, 3115, 2749, 2292, 2294 ].indexOf(id) != -1) boost = 2;
            if([ 2756, 2793, 2832, 2853, 2887, 2888, 2889, 2996, 2997, 2998 ].indexOf(id) != -1) boost = 1.5;
            if([ 3073, 3071, 3069, 3067, 3065, 5271, 5272, 5273, 5274, 3086, 3081, 3080, 2952, 2950, 2948, 2946, 2944, 2942, 2940, 2938, 2936, 1855, 1810, 16, 2491, 2428, 2219, 2146, 2127, 1891, 2956, 2781, 2473, 2097, 1830, 1595, 1163, 516 ].indexOf(id) != -1) boost = 1.25;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
