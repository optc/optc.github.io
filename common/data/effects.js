...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Treasure Map [Global]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 2759 ].indexOf(id) != -1) boost = 3;
            if([ 2761, 2760, 2741, 1387, 1388, 1389, 1446, 1447, 1448, 1549, 1550, 1551 ].indexOf(id) != -1) boost = 2.5;
            if([ 2739, 2830, 3378, 2756, 2358, 2743, 2745, 2747, 2881, 2882, 2749, 2755, 2299, 2729, 2763, 2758, 2357, 2446, 5055, 5056, 5057, 2534, 5086, 5087, 5088, 5089, 2601, 5164, 5165, 5166, 5157, 2700, 2725, 2726, 2727, 603, 795, 1298, 1432, 1815, 1830, 1879, 1943, 2398, 2504, 2517, 5070, 5071, 5072, 5073, 1378, 1458, 1733, 1828, 1945, 2193, 2375, 2489, 2569, 2721, 1049, 1051, 1300, 1306, 1326, 1597, 2093, 2292, 2294, 2429, 2491, 2520, 2751, 2753, 1808, 1853, 1916, 1972, 2109, 2175, 2583, 2659, 2690, 1258, 1380, 1530, 1846, 2283, 2381, 1889, 1941, 2000, 5012, 5013, 5014, 5015, 2064, 2137, 2211, 2261, 2336, 2362, 2387, 2443, 2469, 5062, 5063, 5064, 5065, 2510, 2557, 5140, 5141, 5142, 5143, 2618, 5176, 5177, 5178, 5179 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
    ...
    'Treasure Map [Japan]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 2910, 2911, 2912, 2895, 2897, 2879, 5251, 5252, 5253, 5254 ].indexOf(id) != -1) boost = 2.5;
            //if([ 0 ].indexOf(id) != -1) boost = 1.3;
            if([ 2860, 5217, 5218, 5219, 2862, 5224, 5225, 5226, 5227, 2909, 2899, 2901, 2903, 2890, 2891, 2883, 1808, 1916, 1941, 1972, 2000, 5012, 5013, 5014, 5015, 2109, 2175, 2299, 2387, 2443, 2557, 5140, 5141, 5142, 5143, 2583, 2618, 5176, 5177, 5178, 5179, 2659, 2729, 2913, 2885, 2886, 2893, 2908 ].indexOf(id) != -1) boost = 1.25;
            if([ 1707, 1847, 2434, 746, 1285, 1372, 1485, 1676, 1963, 603, 836, 1108, 1163, 1432, 1595, 1815, 1879, 1924, 2263, 2356, 2394, 2684, 862, 1141, 1220, 1602, 1667, 1978, 2037, 2354, 2489, 2721, 2755, 2283, 1049, 1384, 1867, 2019, 2127, 2146, 2177, 2219, 2327, 2524, 2753, 2782 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
	...
	'Kizuna Clash [Global]': {
        ...
        atk: function(p) {
            var id = p.number + 1,
                matching = ([ 2756, 2749, 2747, 2745, 2743, 2741, 2299, 2755 ].indexOf(id) != -1);
            return !matching ? 1 : 2;
        },
        hp: function(p) {
            var id = p.number + 1,
