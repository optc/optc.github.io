...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Treasure Map [Japan]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 3386, 3387, 3388, 3376, 3378, 3368 ].indexOf(id) != -1) boost = 2.5;
            //if([ 0 ].indexOf(id) != -1) boost = 1.3;
            if([ 2774, 3275, 3065, 5271, 5272, 5273, 5274, 3225, 3349, 5339, 3355, 5340, 3357, 3364, 3369, 3358, 3359, 3360, 3380, 3381, 5255, 5256, 5257, 5258, 3383, 3385, 3373, 3396, 3382, 3361, 3352, 3374, 3353, 1916, 2175, 2443, 2659, 2792, 2879, 2977, 2995, 3217, 3339, 3389 ].indexOf(id) != -1) boost = 1.25;
	...
	'Kizuna Clash [Global]': {
        ...
        atk: function(p) {
            ...
            if([ 3213, 3311, 3275, 3274, 3273, 3269, 3262, 3261, 3259, 3257, 3255, 3253, 5302, 5303, 3251, 3249, 3248, 3247, 3246, 3245, 3241 ].indexOf(id) != -1) boost = 2;
            if([ 3242, 3212 ].indexOf(id) != -1) boost = 1.5;
