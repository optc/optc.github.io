...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
	...
	'Kizuna Clash [Japan]': {
        ...
        atk: function(p) {
            var id = p.number + 1,
                matching = ([ 2954, 2953, 2952, 2950, 2948, 2946, 2944, 2942, 2938, 2936, 2930, 2923, 2922, 2920, 2913 ].indexOf(id) != -1);
            return !matching ? 1 : 2;
        },
        hp: function(p) {
            var id = p.number + 1,
