...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Treasure Map [Worldwide]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 3978, 3979, 3980, 3971, 3973, 5531, 5532, 5533, 5534, 3965 ].indexOf(id) != -1) boost = 2.5;
            if([ 3974, 3975, 3967, 3944, 3945, 3954, 3956, 3959, 3960, 3961, 3948, 3949, 3950, 3951, 3976, 3969, 5524, 5525, 5526, 3981, 3936, 3946, 3942, 3941, 3952, 3940, 3915, 3864, 3712, 3663, 3645, 3060, 2659, 2064, 5520, 5521, 5522, 5523, 5263, 5264, 5265, 5266, 3364, 3462, 3483, 3523, 3543, 3563, 3641, 3735, 3775, 3861, 3933, 5393, 5394, 5395, 5396, 5516, 5517, 5518, 5519, 3777, 3776, 3820, 3819, 3821, 3963, 3962, 3964, 3934, 3935 ].indexOf(id) != -1) boost = 1.25;
            if([ 2936, 2938, 2940, 2942, 2944, 2946, 2948, 2950, 2952, 3884, 3886, 3922, 3924, 3925, 3926, 3920, 3927, 3931, 2886, 3209, 2885, 2795, 2394, 5018, 2356, 1879, 1374, 836, 390, 3017, 2845, 2813, 2375, 2323, 2755, 1630, 1251, 3580, 3499, 3539, 5500, 5501, 5502, 5503, 5508, 5509, 5510, 5511, 5492, 5493, 5494, 5495, 5187, 5188, 5189, 5190, 2158, 2684, 1963, 2146, 2015, 1051, 899, 3108, 1072 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
	...
	'Kizuna Clash [Worldwide]': {
        ...
        atk: function(p) {
            ...
            if([ 3967, 3968, 3948, 3949, 3950, 3951, 3952, 3954, 3956, 3959, 3960, 3961, 3962, 3963, 3964, 3965, 3969, 2446, 5524, 5525, 5526, 5055, 5056, 5057 ].indexOf(id) != -1) boost = 2;
            if([ 3938, 3937, 3886, 2936, 2938, 2940, 2942, 2944, 2946, 2948, 2950, 2952, 3884, 1916, 2137, 1972, 2000, 3824, 3780, 3300, 3204, 3782, 3372, 3371, 3370, 3417, 2338, 3369, 3071, 3073, 2536, 3902, 3666, 2365, 2236, 3510, 3065, 2076, 2588, 2265, 3048, 2958, 2962, 2080, 3936, 3078, 3022, 5012, 5013, 5014, 5015, 5303, 5304, 5305, 5306, 5184, 5185, 5186, 5093, 5094, 5095, 5469, 5470, 5471, 5271, 5272, 5273, 5274 ].indexOf(id) != -1) boost = 1.5;
        ...
        rainbow: function(p) {
            ...
            if([ 3967, 3968 ].indexOf(id) != -1) return true;
        },
	},
