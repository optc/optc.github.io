...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Treasure Map [Global]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 2910 ].indexOf(id) != -1) boost = 3;
            if([ 2912, 2911, 2895, 5251, 5252, 5253, 5254, 2897, 1387, 1388, 1389, 1446, 1447, 1448, 1549, 1550, 1551 ].indexOf(id) != -1) boost = 2.5;
            if([ 2860, 5217, 5218, 5219, 2862, 5224, 5225, 5226, 5227, 2909, 2899, 2901, 2903, 2892, 2887, 2888, 2889, 2883, 2885, 2886, 2893, 2908, 2879, 2913, 2880, 2890, 2891, 1707, 1847, 2338, 2434, 2876, 2877, 2878, 603, 836, 1108, 1163, 1432, 1595, 1815, 1879, 1924, 2263, 2356, 2394, 2684, 862, 1141, 1220, 1602, 1667, 1978, 2037, 2354, 2489, 2721, 2755, 1049, 1384, 1867, 1963, 2019, 2127, 2146, 2177, 2219, 2327, 2524, 2753, 2782, 1808, 1916, 1941, 1972, 2000, 5012, 5013, 5014, 5015, 2109, 2175, 2299, 2387, 2443, 2557, 5140, 5141, 5142, 5143, 2583, 2618, 5176, 5177, 5178, 5179, 2659, 2729, 746, 1285, 1372, 1485, 1676, 2283, 1853, 1889, 2064, 2137, 2211, 2261, 2469, 5062, 5063, 5064, 5065, 2510, 2336, 2362, 2690, 2792, 2763, 2823, 2850, 5210, 5211, 5212, 5213 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
    ...
    'Treasure Map [Japan]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 3057, 3059, 3027, 3038, 3022 ].indexOf(id) != -1) boost = 2.5;
            //if([ 0 ].indexOf(id) != -1) boost = 1.3;
            if([ 3007, 3009, 3048, 3011, 3013, 3015, 3029, 3031, 3040, 3042, 3044, 3047, 3049, 3052, 3032, 3033, 3034, 3035, 3045, 3046, 3050, 1853, 1941, 2000, 5012, 5013, 5014, 5015, 2261, 2362, 2443, 2469, 5062, 5063, 5064, 5065, 2510, 2659, 2879, 2977, 2995, 3060, 5263, 5264, 5265, 5266 ].indexOf(id) != -1) boost = 1.25;
            if([ 2159, 2500, 2631, 2991, 865, 1047, 1432, 1595, 1879, 2394, 2684, 2795, 5187, 5188, 5189, 5190, 1310, 1338, 1602, 1733, 1861, 1897, 2163, 2290, 2489, 2569, 2649, 2869, 3017, 1328, 1520, 1626, 2019, 2021, 2089, 2377, 1060, 2936, 2938, 2940, 2942, 2944, 2946, 2948, 2950, 2952 ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
	...
	'Kizuna Clash [Global]': {
        ...
        atk: function(p) {
            var id = p.number + 1,
                matching = ([ 2881, 2882, 2883, 2869, 2879, 2880, 2860, 2862, 2866, 2867, 2868, 2887, 2888, 2889, 5217, 5218, 5219, 5224, 5225, 5226, 5227, 5232, 5234, 5235, 5236, 5240, 5241, 5242, 5243, 5244, 5255, 5256 ].indexOf(id) != -1);
            return !matching ? 1 : 2;
        },
        hp: function(p) {
            var id = p.number + 1,
	...
	'Kizuna Clash [Japan]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 3051, 3053, 3049, 3048, 3047, 3046, 3045, 3044, 3042, 3040, 3038 ].indexOf(id) != -1) boost = 2;
            //if([ 2889, 2888, 2887, 2853, 2832, 2793, 2756 ].indexOf(id) != -1) boost = 1.5;
            //if([ 2977, 2976, 2975, 2974, 2973, 2972, 2970, 2968, 2966, 2964, 2962, 2960, 2958, 2956, 2952, 2950, 2948, 2946, 2944, 2942, 2940, 2938, 2936, 2934, 2893, 2281, 2158, 2097, 2015, 1830, 1595, 1518, 1298, 2521, 2146, 2127, 2095, 2087, 2046, 1995, 1918, 1581, 899, 1879 ].indexOf(id) != -1) boost = 1.25;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
