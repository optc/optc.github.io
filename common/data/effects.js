...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Treasure Map [Japan]': {
        ...
        atk: function(p) {
            var boost = 1;
            var id = p.number + 1;
            if([ 3271, 3270, 3272, 5309, 3253, 5310, 3239 ].indexOf(id) != -1) boost = 2.5;
            //if([ 0 ].indexOf(id) != -1) boost = 1.3;
            if([ 3225, 3227, 3240, 3245, 3229, 3231, 3255, 3257, 3259, 3261, 3269, 3241, 3251, 3247, 3262, 3235, 3233, 3222, 3223, 1916, 2109, 2175, 2443, 2763, 2879, 2995, 3115, 3217, 3273 ].indexOf(id) != -1) boost = 1.25;
            if([ 3175, 3177, 3179, 3181, 3183, 3185, 447, 603, 978, 989, 1432, 1943, 2097, 2473, 2504, 2885, 2886, 3078, 3209, 983, 1089, 1143, 1251, 1310, 1376, 1401, 2249, 2569, 2813, 2869, 2908, 3017, 3049, 3210, 713, 1037, 1918, 2429, 2523, 2634, 3207, 3213, 3208, 3186, 3187, 3188, 2936, 2938, 2940, 2942, 2944, 2946, 2948, 2950, 2952,  ].indexOf(id) != -1) boost = 1.2;
            return boost;
        },
        hp: function(p) {
            var boost = 1;
