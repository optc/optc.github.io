(function () {
    ...
    utils.getBigThumbnailUrl = function (n) {
        switch (n){
            ...
            /*case 'Sanjiskull':
            case 9023: return 'http://onepiece-treasurecruise.com/wp-content/uploads/Sanji_skull_c.png'; break;
            case 'Frankyskull':
            case 9024: return 'http://onepiece-treasurecruise.com/wp-content/uploads/Franky_skull_c.png'; break;*/
        }
