(function () {
    ...
    utils.getThumbnailUrl = function (n, relPathToRoot = '') {
        switch (n){
            ...
            case 'skullSTR':
            case 9010: return relPathToRoot + '/api/images/common/skull-STR.png';
            case 'skullQCK':
            case 9011: return relPathToRoot + '/api/images/common/skull-QCK.png';
            case 'skullPSY':
            case 9012: return relPathToRoot + '/api/images/common/skull-PSY.png';
            case 'skullDEX':
            case 9013: return relPathToRoot + '/api/images/common/skull-DEX.png';
            case 'skullINT':
            case 9014: return relPathToRoot + '/api/images/common/skull-INT.png';
            case 'skullJudge':
        ...
        switch(id){
            ...
            case (ghostPoint+46).toString(): return relPathToRoot + '/api/images/thumbnail/jap/2/400/2468-1.png'; break;
            case (ghostPoint+47).toString(): return relPathToRoot + '/api/images/thumbnail/jap/2/400/2468-2.png'; break;
            case (ghostPoint+48).toString(): return relPathToRoot + '/api/images/thumbnail/jap/2/400/2468-PSY.png'; break;
            case (ghostPoint+49).toString(): return relPathToRoot + '/api/images/thumbnail/jap/2/400/2468-QCK.png'; break;
